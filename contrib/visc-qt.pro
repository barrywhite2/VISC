...
RESOURCES += src/qt/VISC.qrc src/qt/VISC_locale.qrc

TRANSLATIONS += src/qt/locale/VISC_bg.ts \
                src/qt/locale/VISC_de.ts \
                src/qt/locale/VISC_en.ts \
                src/qt/locale/VISC_es.ts \
                src/qt/locale/VISC_fi.ts \
                src/qt/locale/VISC_fr.ts \
                src/qt/locale/VISC_it.ts \
                src/qt/locale/VISC_ja.ts \
                src/qt/locale/VISC_pl.ts \
                src/qt/locale/VISC_pt.ts \
                src/qt/locale/VISC_ru.ts \
                src/qt/locale/VISC_sk.ts \
                src/qt/locale/VISC_sv.ts \
                src/qt/locale/VISC_vi.ts \
                src/qt/locale/VISC_zh_CN.ts \
                src/qt/locale/VISC_zh_TW.ts

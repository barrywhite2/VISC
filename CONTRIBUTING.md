Contributing to VISC Core
============================

The VISC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VISC Core project, and is not to be
confused with overall VISC Network Protocol consensus changes.

Whether a pull request is merged into VISC Core rests with the project merge
...
Patches that change VISC consensus rules are considerably more involved than
...
Where a patch set proposes to change the VISC consensus, it must have been
...
The project leader is the release manager for each VISC Core release.

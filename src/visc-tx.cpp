...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VISC Core VISC-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  VISC-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VISC transaction") + "\n" +
                               "  VISC-tx [options] -create [commands]   " + _("Create hex-encoded VISC transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded VISC transaction
